...
- [x] [Blog plugin: pinned posts] :material-alert-decagram:
- [x] [Instant previews] :material-alert-decagram:
- [x] [Footnote tooltips] :material-alert-decagram:
...
[:octicons-heart-fill-24: &nbsp; Show your support <span class="mdx-sponsorship-count" data-mdx-component="sponsorship-count"></span>][sponsoring tiers]
...
:octicons-check-circle-fill-24: already available or
