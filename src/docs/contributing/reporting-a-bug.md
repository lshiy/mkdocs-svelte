...
| <!-- --> | Example  |
| -------- | -------- |
| :material-check: __Clear__ | Built-in `typeset` plugin changes precedence of nav title over `h1`
| :material-close: __Wordy__ | The built-in `typeset` plugin changes the precedence of the nav title over the document headline
| :material-close: __Unclear__ | Title does not work
...
[:material-bug: Create reproduction][Create reproduction]
