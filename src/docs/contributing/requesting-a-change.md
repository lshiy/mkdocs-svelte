...
[:octicons-comment-discussion-16:&nbsp; Start a discussion][discussion board]
...
| <!-- --> | Example  |
| -------- | -------- |
| :material-check: __Clear__ | Index custom front matter in search
| :material-close: __Wordy__ | Add a feature where authors can define custom front matter to be indexed in search
| :material-close: __Unclear__ | Improve search
