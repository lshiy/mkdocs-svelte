...
- :material-checkbox-blank-circle: `--md-code-hl-number-color`
- :material-checkbox-blank-circle: `--md-code-hl-special-color`
- :material-checkbox-blank-circle: `--md-code-hl-function-color`
- :material-checkbox-blank-circle: `--md-code-hl-constant-color`
- :material-checkbox-blank-circle: `--md-code-hl-keyword-color`
- :material-checkbox-blank-circle: `--md-code-hl-string-color`
- :material-checkbox-blank-circle: `--md-code-hl-name-color`
- :material-checkbox-blank-circle: `--md-code-hl-operator-color`
- :material-checkbox-blank-circle: `--md-code-hl-punctuation-color`
- :material-checkbox-blank-circle: `--md-code-hl-comment-color`
- :material-checkbox-blank-circle: `--md-code-hl-generic-color`
- :material-checkbox-blank-circle: `--md-code-hl-variable-color`

Code block foreground, background and line highlight colors are defined via:

- :material-checkbox-blank-circle: `--md-code-fg-color`
- :material-checkbox-blank-circle: `--md-code-bg-color`
- :material-checkbox-blank-circle: `--md-code-hl-color`
